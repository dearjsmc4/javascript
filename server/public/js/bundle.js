...
(function () {
  ...
  function render(resTodo) {
    todos = resTodo;
    var filterTodos = [];
    if (navId === 'all') filterTodos = _toConsumableArray(todos);else if (navId === 'active') filterTodos = todos.filter(function (todo) {
      return !todo.completed;
    });else filterTodos = todos.filter(function (todo) {
      return todo.completed;
    });
    var html = '';
    filterTodos.forEach(function (_ref) {
      var id = _ref.id,
  ...
  function removeTodo(id) {
    fetchTodo('DELETE', "/todos/".concat(id));
  }
  ...
  $todos.onchange = function (e) {
    ...
    if (e.target.checked) {
      fetchTodo('PATCH', "/todos/".concat(id), {
        completed: true
      });
    } else {
      fetchTodo('PATCH', "/todos/".concat(id), {
